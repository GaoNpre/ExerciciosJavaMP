...
public class ShowStats {
    ...
    public ShowStats(String userName, String date, String videoId, Integer totalSegments, Integer watchedSegments, String watchedPercentage, Integer lastWatchedSegment) {
